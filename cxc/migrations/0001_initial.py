    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metodo', models.CharField(choices=[('Efectivo', 'Efectivo'), ('Transferencia', 'Transferencia'), ('Tarjeta', 'Tarjeta'), ('Cheque', 'Cheque')], default='Efectivo', max_length=15)),
                ...
                ('cxc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pagos', to='cxc.cuentaporcobrar')),
            ],
            options={
                'db_table': 'pagos_cxc',
                'ordering': ['-fecha'],
